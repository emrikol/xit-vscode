...
export const COMMANDS = ['xit.suggest', 'xit.toggle', 'xit.shuffle', 'xit.refreshItems', 'xit.toggleDoneItems', 'xit.migrate', 'xit.postpone', 'xit.sortGroup', 'xit.archive', 'xit.giveId'];
